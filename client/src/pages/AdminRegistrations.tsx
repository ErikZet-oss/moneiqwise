...
export default function AdminRegistrations() {
  ...
  return (
    <div className="max-w-5xl mx-auto flex flex-col gap-3 md:gap-6 px-1 sm:px-0 pb-10">
      <div className="space-y-2">
        <div className="flex items-start gap-2">
          <h1 className="text-lg font-semibold leading-tight">Registrácie používateľov</h1>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 sm:gap-3">
        ...
        >
          ...
          <div className="text-2xl font-semibold leading-tight tracking-tight tabular-nums mt-1">{counts.pending}</div>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <div className="text-2xl font-semibold leading-tight tracking-tight tabular-nums mt-1">{counts.approved}</div>
        </button>
        <button
          type="button"
        ...
        >
          ...
          <div className="text-2xl font-semibold leading-tight tracking-tight tabular-nums mt-1">{counts.blocked}</div>
        </button>
      </div>
      ...
      <Card>
        <CardHeader className="space-y-3 p-4 pb-2">
          <div>
            <CardTitle className="text-sm font-medium">Zoznam e-mailov</CardTitle>
              ...
              <div className="md:hidden space-y-3">
                {rows.map((row) => {
                  ...
                  return (
                    <div
                      key={row.id}
                      className="rounded-xl border bg-card py-2 px-3 space-y-2 shadow-sm"
                    >
