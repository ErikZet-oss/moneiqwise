  ...
  return (
    <div className="flex flex-col gap-3 md:gap-6 pb-6 md:pb-8">
        ...
        <div className="flex flex-col gap-2">
          <Card className="border-primary/20 bg-primary/[0.04]">
            <CardContent className="p-3 space-y-1.5">
              ...
              <p className="text-xs leading-relaxed">{runResult.insight}</p>
              ...
              return (
                <Card key={pick.ticker} className="relative overflow-hidden">
                  ...
                  <CardContent className="relative p-2 space-y-1.5">
                    ...
                    <p className="text-[10px] leading-snug text-foreground/90">{pick.comment}</p>
                    {pick.risk ? (
                      <p className="text-[9px] text-muted-foreground leading-snug">Riziko: {pick.risk}</p>
                    ) : null}
        ...
        <div className="flex flex-col gap-2">
          <Card className="border-primary/20 bg-primary/[0.04]">
            <CardContent className="p-3 space-y-1.5">
              ...
              <p className="text-xs leading-relaxed">{tickerResult.summary}</p>
      ...
      {!isBusy && !runResult && !tickerResult && (
        <Card>
          <CardContent className="p-4 text-center text-xs text-muted-foreground">
            Vyber stratégiu a spusti skener, alebo vyhľadaj ticker pre Claude verdikt.
          </CardContent>
        </Card>
      )}
    </div>
